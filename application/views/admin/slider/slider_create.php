                            ...
                            <fieldset>
                                <legend><span>Create Slider  </span>
                                    ...
                                    <div class="site_nav">
                                        ...
                                        &raquo;<a href="<?= base_url() ?>admin/slider"> Slider </a>
                                        &raquo; create
                                    </div>
                                </legend>
                                    ...
                                    <div class="tab-content">
                                        <div id="prod_tab_general" class="tab-pane active">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <label for="code">Slider Code</label>
                                            ...
                                            <div class="row" >
                                                <div class="col-lg-6" >
                                                   <div class="form-group" >
                                                    ...
                                                    <input type="text" id="name" name="form[title_1]"
                                                           value="<?= $result->title_1 ?>"
                                                           class="form-control" >
														   
														   </div>	   
                                                 <div class="form-group" >
                                                    <label for="name"> Title 2 </label>
                                                    <input type="text" id="name" name="form[title_2]"
                                                           value="<?= $result->title_2 ?>"
                                                           class="form-control"  >
													</div>	   
                                                ...
                                                <div class="col-lg-6" >
                                                    ...
                                                    <input type="url" id="name" name="form[url]"
                                                           value="<?= $result->url ?>"
                                                           class="form-control"  >
													</div>
													<div class="form-group" >
                                                    <label for="name"> Description </label>
                                                    <input type="text" id="name" name="form[description]"
                                            ...
                                            <div class="col-lg-6" >
                                                ...
                                                <small> image size ( 1000px * 505px ) </small>
