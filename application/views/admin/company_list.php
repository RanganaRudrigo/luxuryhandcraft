...
<html>
<head>
    <title>Company List <?= date("d-m-Y") ?> </title>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">Company List
                            <div  class="site_nav" >
                        ...
                        <div class="panel-body table-responsive">
                            <table id="dt_tableTools" class=" table table-striped table-bordered  ">
                                ...
                                <?php foreach($records as $k => $row): ?>
                                    <tr>
                                        <td><?= $k+1 ?></td>
                                        <td> <img src="<?= base_url()."uploads/thumbs/".$row->image ?>" width="50" > </td>
                                        <td><?= $row->title ?></td>
    ...
    row  = {
        remove: function(self){
            if(confirm("Are You Sure Do your can to delete this record ???  ")){
                $.ajax({
                    url : "<?= base_url() ?>admin/company/remove",
