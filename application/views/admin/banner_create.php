                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <fieldset>
                                <legend><span>Create Banner  </span>

                                    <div class="site_nav">
                                        <a href="<?= base_url() ?>admin">Dashboard</a>
                                        &raquo;<a href="<?= base_url() ?>admin/banner"> Banner </a>
                                        &raquo; create
                                    </div>
                                </legend>
                                        ...
                                        <div id="prod_tab_general" class="tab-pane active">
                                            <div class="form-group">
                                                <div class="col-lg-6">
                                                    ...
                                                    <input type="url" id="name" name="form[title]"
                                                           value="<?= $result->title ?>"
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-3">
                                                    <label for="map"> Banner position </label>
                                                    <select class="form-control" name="form[position]"  data-parsley-required="true" >
                                                        <option value="1" <?= $result->position == 1 ? "selected" :"" ?>  > Top </option>
                                                        <option value="2" <?= $result->position == 2 ? "selected" :"" ?>  > After Slider </option>
                                                        <option value="3" <?= $result->position == 3 ? "selected" :"" ?>  > Normal </option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6" style="margin-top: 10px" >
                                                ...
                                                <small>
                                                    <ul>
                                                        <li> Top : 610px * 88px , Only one top Banner will appear so it always so latest Banner </li>
                                                        <li> After Slider : 270px * 200px , Only four Banner will appear so it always so latest four Banner   </li>
                                                        <li> Normal : 1250px * 120px  </li>
                                                    </ul>
                                                </small>
                                            </div>
                                            <div class="clearfix" ></div>
