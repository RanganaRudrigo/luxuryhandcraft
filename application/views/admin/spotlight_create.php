                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <fieldset>
                                <legend><span>Create Spotlight  </span>

                                    <div class="site_nav">
                                        <a href="<?= base_url() ?>admin">Dashboard</a>
                                        &raquo;<a href="<?= base_url() ?>admin/spotlight"> Spotlight </a>
                                        &raquo; create
                                    </div>
                                </legend>
                                    ...
                                    <div class="tab-content">
                                        <div id="prod_tab_general" class="tab-pane active">
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <label for="name">Spotlight Name</label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <label for="code">Spotlight Code</label>
                                            ...
                                            <div class="form-group form-sep">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <label for="short" class="req">Spotlight Short Description (maximum text 150) </label>
                                            ...
                                            <div class="form-group form-sep">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <label for="description" class="req">Spotlight Description</label>
        ...
        init: function () {
            if ($('#image_upload').length) {
                ...
                $('#image_upload').fileupload({
                    url: '<?= base_url() ?>admin/spotlight/do_upload',
                    dataType: 'json',
                    autoUpload: false,
        ...
        default_image : function(){
            ...
            $('#default_image_upload').fileupload({
                ...
                .on('fileuploaddone', function (e, data) {
                    $.each(data.result.files, function (index, file) {
                        if (file.url) {
                            $(data.context.children()[index]).find('.upload_img_actions').append('<div class="alert alert-success">Upload success <br/><a class="alert-link" target="_blank" href=' + file.url + '>show  image</a><input type="hidden" name="form[image]" value="' + file.name + '" > </div>');
                        } else if (file.error) {
                            $(data.context.children()[index]).find('.upload_img_actions').append($('<div class="alert alert-danger"/>').text(file.error));
                        }
                    });
