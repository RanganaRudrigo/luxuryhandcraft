                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <fieldset>
                                <legend><span>Create manufacturer  </span>

                                    <div class="site_nav">
                                        <a href="<?= base_url() ?>admin">Dashboard</a>
                                        &raquo;<a href="<?= base_url() ?>admin/manufacturer<?= $this->input->get('manufacturer_id') ? "?manufacturer_id={$this->input->get('manufacturer_id')}" : ""?>"> manufacturer </a>
                                        &raquo; create
                                    </div>
                                </legend>
                                        ...
                                        <div id="prod_tab_general" class="tab-pane active">
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <label for="code">manufacturer Code</label>
                                            ...
                                            <div class="form-group form-sep">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <label for="short" class="req">manufacturer Short Description (maximum text 150) </label>
                                            ...
                                            <div class="form-group form-sep">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <label for="description" class="req">manufacturer Description</label>
        ...
        init: function () {
            if ($('#image_upload').length) {
                ...
                $('#image_upload').fileupload({
                    url: '<?= base_url() ?>admin/manufacturer/do_upload',
                    dataType: 'json',
                    autoUpload: false,
