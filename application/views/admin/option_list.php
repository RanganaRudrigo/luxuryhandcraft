            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">option List
                            <div  class="site_nav" >
                        ...
                        <div class="panel-body">
                            ...
                            <div class="pull-right" >
                                <a class=" btn btn-primary fa fa-plus" href="<?= current_url() ?>/create/<?= $id ? "?option_id=$id" : "" ?>" > Create  </a>
                            </div>
    ...
    row  = {
        remove: function(self){
            if(confirm("Are You Sure Do your can to delete this record ???  ")){
                $.ajax({
                    url : "<?= base_url() ?>admin/option/remove",
