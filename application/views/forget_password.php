        ...
        <div class="container">
            <div class="row">
                ...
                <section id="center_column" class="col-md-12">
                    <h1 class="page-heading"> Password Reset </h1>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                            ...
                            <form action="" method="post"   class="box panel panel-default">
                                <h3 class="panel-heading">Type Your Email Id</h3>
                                <div class="form_content panel-body clearfix">
                                    <p>Please enter your email address to change your account password .</p>
                                    ...
                                    <div class="submit">
                                        ...
                                        <button class="btn btn-outline button button-medium exclusive" type="submit" id="SubmitCreate" name="SubmitCreate"> <span> <i class="fa fa-user left"></i> Change Password </span> </button>
                                        <input type="hidden" class="hidden" name="SubmitCreate" value="Change Password" />
                                    </div>
                                </div>
                            </form>
                        </div>
