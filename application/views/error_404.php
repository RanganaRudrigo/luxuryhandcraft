    ...
    <section id="columns" class="columns-container">
        <div class="container">
            <div class="row">
                ...
                <!-- Center -->
                <center>
                    <section style="margin-top: 25px"  class="col-md-12">

                        <div class="pagenotfound">
                            <div class="img-404">
                                <img src="<?= base_url() ?>images/404.png" alt="Page not found">
                            </div>
                            ...
                            <div class="buttons"><a class="btn btn-outline button button-medium" href="<?= base_url() ?>" title="Home"><span>Home page</span></a></div>
                        </div>
