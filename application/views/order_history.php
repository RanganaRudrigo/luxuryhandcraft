              ...
              <tbody>
                <?php foreach($orders as $o ): ?>
                  <tr class="first_item " <?= $o->id == $order->id  ?" style='background-color: #cbcbcb' ":"" ?>   >
                    ...
                    <td class="history_price"   style="display: table-cell;"><span class="price"> <?= number_format($o->total+$o->shipping,2)?> LKR </span></td>
                  ...
                  <table class="table table-bordered">
                    ...
                    <!-- <tr class="item">
                     ...
                     <tr class="item">
                       ...
                       <td colspan="4"><span class="price"><?= number_format($order->total,2) ?> LKR</span></td>
                     </tr>
                     <tr class="item">
                       <td colspan="1"><strong>Shipping &amp; handling (tax incl.) </strong></td>
                       <td colspan="4"><span class="price-shipping"><?= number_format($order->shipping,2) ?> LKR</span></td>
                     </tr>
                    <tr class="totalprice item">
                      <td colspan="1"><strong>Total</strong></td>
                      <td colspan="4"><span class="price"><?= number_format($order->total+$order->shipping,2) ?> LKR</span></td>
                    </tr>
                    </tfoot>
                    <tbody>
                    <!-- Customized products -->
                    ...
                    <?php foreach($carts as $cart ): ?>
                      <tr class="item">
                        ...
                        <td class="price"><label for="cb_24"> <?= number_format($cart['price'],2) ?> LKR </label></td>
                        <td class="price"><label for="cb_24"> <?= number_format($cart['subtotal'],2) ?> LKR  </label></td>
                      </tr>
                    <?php endforeach ?>
                    </tbody>
                  </table>
