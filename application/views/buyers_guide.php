    ...
    <div id="breadcrumb" class="clearfix">
        <div class="container">
            ...
            <div class="breadcrumb clearfix"><a class="home" href="" title="Return to Home"><i
                        class="fa fa-home"></i></a> <span class="navigation-pipe">&gt;</span>Buyer’s Guide
            </div>
            <!-- /Breadcrumb -->
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12">
                                <div class="cms-block">
                                    ...
                                    <p>Buying products on luxuryhandcraft.com is easy. Navigation through categories,
                                        searching for specific products and product selection are simple. Wheremulti
                                        paymentoptions are supported for all of your needs. Get started by following
                                        some simple steps: </p>
                                    <ul>
                                        <li><a href="#buy-page-1">Search and explore products </a></li>
                                        <li><a href="#buy-page-2">Learn about the product, and Add to cart</a></li>
                                        <li><a href="#buy-page-3">Review your shopping cart, and Sign in to checkout</a>
                                        </li>
                                        <li><a href="#buy-page-4">Place your order</a></li>
                                        <li><a href="#buy-page-5">Congrats! Track your order until it's delivered to
                                                your door</a></li>
                                    </ul>
