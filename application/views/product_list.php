                                                ...
                                                <div class="product-meta">
                                                    ...
                                                    <div class="content_price">
                                                        <?php if($pro->discount > 0  ): ?>
                                                            <span    class="price product-price"> <?= number_format( round( (100-$pro->discount)/100 * $pro->price ) , 2 ) ?> LKR </span>
                                ...
                                <div class="product-container product-block" itemscope itemtype="">
                                    ...
                                    <div class="right-block">
                                        <div class="product-meta">
                                            ...
                                            <div class="content_price">
                                                <?php if($pro->discount > 0  ): ?>
                                                    <span    class="price product-price"> <?= number_format( round( (100-$pro->discount)/100 * $pro->price ) , 2 ) ?> LKR </span> <br/>
                                                    <span    class="old-price product-price">  <?= number_format($pro->price ,2) ?> LKR </span>
                                                    <span class="price-percent-reduction">-<?=round($pro->discount)  ?>%</span>
                                                <?php else: ?>
                                                    <span    class="price product-price"> <?= number_format($pro->price ,2) ?> LKR </span>
