...
function addToCompare(productId, productName)
{
	...
	var url_list_comapre = baseUri+'user/compare';
	...
	$.ajax({
		url: baseUri + 'cart/add_to_compare/?product_id=' + productId,
		async: true,
		cache: false,
		success: function(data) {
			if (action === 'add' && comparedProductsIds.length < comparator_max_item) {
				...
				var content_alert = 'The product <strong>'+productName+'</strong> has been added to list compare. <a href="'+url_list_comapre+'"><strong>Click to view list compare</strong></a>';
				...
				var content_alert = 'The product <strong>'+productName+'</strong> has been removed from list compare. <a href="'+url_list_comapre+'"><strong>Click to view list compare</strong></a>';
				if (!!$.prototype.fancybox)
					$.fancybox.open([{
						type: 'inline',
						autoScale: true,
